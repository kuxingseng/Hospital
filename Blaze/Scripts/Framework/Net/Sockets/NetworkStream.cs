namespace Blaze.Framework.Net.Sockets
{
    ...
    /// <summary>
    /// 替代System.Net命名空间下的NetworkStream，提供WP8兼容性。
    /// <remarks> https://github.com/kerryjiang/SuperSocket.ClientEngine/blob/master/Core/NetworkStream.cs </remarks>
    /// </summary>
    public class NetworkStream : Stream
    {
        ...
        {
            var resetEvent = (ManualResetEvent)result.AsyncState;
            resetEvent.Set();
        }
        ...
        public override IAsyncResult BeginRead(byte[] buffer, int offset, int count, AsyncCallback callback, object state)
        {
            ...
            var result = new StreamAsyncResult(e, callback);
